...
var flowControl = new (require('./flowControl'))();
...
module.exports = {
  ...
  setTestUrl: flowControl.setTestUrl,

  doRequest: function (method, path, data, options) {
    return flowControl.request.apply(this, arguments);
  },
